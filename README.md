...
- The "Context Dependent Decision-Making RNN" of Mante et al. (2013): the SSM reduction and analysis is in "cddm demo.ipynb", the SSM-reduction of the noisy network is in "cddm_demo_noisy.ipynb"; 
- The "Sine-Wave Generator RNN" of Krause et al. (2022): in "swg demo.ipynb";
- The "Multitasking RNN" of Driscoll et al. (2024) performing a "Memory-Pro task": in "mt demo.ipynb";
